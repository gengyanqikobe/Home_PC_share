...
global bottom,phonenumber,account


tem_datas = Register().web_rj()
browser = tem_datas[0]
account = tem_datas[1]
corp_name = account +'的公司'
#corp_name = '北京颖泰嘉和生物科技股份有限公司'
phonenumber = tem_datas[2]
password = 'w123456'
...
browser.get('http://mxt.innotree.cn/auth/credit/bind')
time.sleep(1)
browser.execute_script(bottom)
time.sleep(1)
browser.find_element_by_xpath('/html/body/div/div[1]/div/form/div[2]/div/div[2]/div/div/input').send_keys(corp_name)
browser.find_element_by_xpath('/html/body/div/div[1]/div/form/div[2]/div/div[3]/div/div/input').send_keys(xinyongma)
browser.find_element_by_xpath('/html/body/div/div[1]/div/form/div[4]/a').click()
...
time.sleep(1)
browser.find_element_by_xpath('//div[@class = "auth-form-item__first"]/div[1]/div[@class = "el-form-item__content"]/div[@class = "el-input"]/input[@class = "el-input__inner"]').send_keys(corp_name)
#browser.find_element_by_xpath('//div[@class = "auth-form-item__first"]/div[1]/div[@class = "el-form-item__content"]/div[@class = "el-input"]/input[@class = "el-input__inner"]').send_keys('京点星（北京）贸易有限公司')
...
browser.find_element_by_xpath('//div[@class = "auth-form-item__first"]/div[3]/div[@class = "el-form-item__content"]/div[@class = "el-input"]/input[@class = "el-input__inner"]').send_keys(xinyongma)
...
time.sleep(1)
browser.find_element_by_xpath('/html/body/div/div[1]/div/div[2]/div/div/form/div[1]/div[4]/div/div/label[1]/span[1]/span').click()
time.sleep(1)
browser.find_element_by_xpath('/html/body/div/div[1]/div/div[2]/div/div/form/div[1]/div[5]/div/div[1]/div[1]/div/div/input').send_keys('10')
browser.find_element_by_xpath('/html/body/div/div[1]/div/div[2]/div/div/form/div[1]/div[5]/div/div[1]/div[2]/div/div/input').send_keys('20')
